...
data = '/home/seps05/Dek_model/WASP-62b.csv'
...
g = 7.3978                   # gravitational acceleration in m/s^2
R_p = 1.32 * R_J           # planet radius in meters
...
prior_ranges = {}
prior_ranges['log_H2O'] = [-12.0,-1.0]
prior_ranges['log_CH4'] = [-12.0,-1.0]
prior_ranges['log_CO'] = [-12.0,-1.0]
prior_ranges['log_CO2'] = [-12.0,-1.0]
prior_ranges['P_ref'] = [-6.0,2.0]
prior_ranges['T_iso'] = [400.0,2000.0]
