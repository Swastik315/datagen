...
# Initial 
chem_species = np.array(['AlH', 'AlO', 'BeH', 'C2H2', 'CH', 'CH4', 'CO', 
...
polarisabilities = {'H2':  0.80e-24,  'He':  0.21e-24, 'N2':   1.74e-24,  'O2':  1.58e-24, 
                    ...
                    'NO':  1.70e-24,  'NO2': 3.02e-24, 'H3+':  0.39e-24,  'OH':  6.97e-24,  
                    'Na':  24.1e-24,  'K':   42.9e-24, 'Li':   24.3e-24,  'Rb':  47.4e-24,     
                    'Cs':  59.4e-24,  'TiO': 16.9e-24, 'VO':   14.4e-24,  'AlO': 8.22e-24,   
                    'SiO': 5.53e-24,  'CaO': 23.8e-24, 'TiH':  16.9e-24,  'MgH': 10.5e-24,
                    'NaH': 24.1e-24,  'AlH': 8.22e-24, 'CrH':  11.6e-24,  'FeH': 9.47e-24,   
                    'CaH': 23.8e-24,  'BeH': 5.60e-24, 'ScH':  21.2e-24,  'LiH': 24.3e-24,
                    'SiH': 5.53e-24,  'CH':  2.59e-24, 'NH':   2.59e-24,  'SH':  2.59e-24,   
                    'PN':  3.69e-24,  'PO':  3.69e-24, 'PS':   3.69e-24,  'Fe':  9.47e-24,   
...
mass_dens = {'ZnS': 4102, 'TiO2': 4230, 'MgSiO3': 3200}  # Densities in kg/m^3
