...
chem_species = ['H2O','CO2','CO','Na','K','SO2','HCN','H2S','NH3']
...
prior_ranges['log_CO'] = [-5.5,-1.0]
prior_ranges['log_Na'] = [-6.0,-4.0]
prior_ranges['log_K'] = [-8.0,-6.0]
prior_ranges['log_SO2'] = [-7,-1.0]
prior_ranges['log_HCN'] = [-7,-1.0]
prior_ranges['log_H2S'] = [-7,-1.0]
prior_ranges['log_NH3'] = [-9,-3.5]
prior_ranges['P_ref'] = [-4.0,-1.0]
prior_ranges['w'] = [1,10]
prior_ranges['lambda_sig'] = [0.3,1.5]
prior_ranges['log_P_cloud_sigmoid'] = [-4,-1]
